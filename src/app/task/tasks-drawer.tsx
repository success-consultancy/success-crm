...
export function TasksDrawer() {
  ...
  const openAddTaskForm = () => {
    setTaskFormState({ isOpen: true, isAddMode: true, isEditMode: false, currentTaskId: null });
  };

  const handleBack = () => {
    setTaskFormState({ isOpen: true, isAddMode: false, isEditMode: false, currentTaskId: null });
  };
  ...
  const closeTaskForm = () => {
    setTaskFormState({ isOpen: false, isAddMode: false, isEditMode: false, currentTaskId: null });
  };
  const openEditTaskForm = (taskId: number) => {
    ...
    if (taskToEdit) {
      setTaskFormState({ isOpen: true, isAddMode: true, isEditMode: true, currentTaskId: taskId });
