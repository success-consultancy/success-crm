...
const STAT_CARDS: StatCard[] = [
  { key: 'uniqueClientCount', label: 'Unique Clients', Icon: User, color: 'text-[#001aff]', bgColor: 'bg-[#ebedff]' },
  { key: 'users', label: 'CRM Users', Icon: Users, color: 'text-[#007b93]', bgColor: 'bg-[#e4f9fa]' },
  { key: 'leads', label: 'Leads', Icon: UserPlus, color: 'text-[#016edf]', bgColor: 'bg-[#ebf4ff]' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {isLoading
          ? Array.from({ length: 8 }).map((_, i) => (
              <CardContainer
                key={i}
                className="border-neutral-border-light rounded-xl shadow-[0px_1px_2px_rgba(10,13,18,0.05)] px-5 pt-4 pb-5"
              >
