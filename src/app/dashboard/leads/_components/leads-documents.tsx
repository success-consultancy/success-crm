...
const columnHeaderStyle = "text-muted-foreground text-sm font-medium text-left p-3 bg-component-hoveredLight border-b border-borderLight";
const cellStyle = "text-sm p-3 border-b border-borderLight";

const LeadsDocumentsTable = () => {
  return (
    <SectionWrapper title='Documents' rightSection={
      <Button variant={'ghost'} className="text-primary-blue">Add Documents</Button>
    }>
