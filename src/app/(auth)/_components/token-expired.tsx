    ...
    <div className={cn(props.className)}>
      <div className="flex flex-col items-center justify-center">
        <div className="w-[7.1875rem] h-[7.1875rem] bg-state-error-light  flex-center rounded-full">
          <Danger
            variant="Linear"
            className="w-11 h-11 text-state-error-dark"
          />
        </div>

        <h5 className="text-center text-h2 text-[2.1875rem] text-state-error-base mt-11">
          Token Expired
        </h5>
        <p className="text-b1 text-center text-content-body mt-4">
          Your token has expired. Please request the new token. It might take
          some time.
        </p>
