...
interface Props {
  ...
  id: number;
  defaultValues: Partial<ISkillAssessment>;
}
...
export function EditSkillAssessment({ userId, id, defaultValues }: Props) {
  ...
  const formDefaultValues: Partial<SkillAssessmentSchemaType> = {
    firstName: defaultValues.firstName || '',
    lastName: defaultValues.lastName || '',
    middleName: defaultValues.middleName || null,
    email: defaultValues.email || '',
    phone: defaultValues.phone || '',
    dob: convertDateForForm(defaultValues.dob),
    country: defaultValues.country || null,
    passport: defaultValues.passport?.toString() || null,
    issueDate: convertDateForForm(defaultValues.issueDate),
    expiryDate: convertDateForForm(defaultValues.expiryDate),
    location: defaultValues.location || null,
    currentVisa: defaultValues.currentVisa || null,
    visaExpiry: convertDateForForm(defaultValues.visaExpiry),
    ...
    dueDate: convertDateForForm(defaultValues.dueDate),
  ...
  const { mutate, isPending } = useEditSkillAssessment();
