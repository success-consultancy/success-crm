        ...
        {SERVICES.map((service) => {
          ...
          return (
            ...
            >
              ...
              <div
                aria-hidden="true"
                className={`w-5 h-5 rounded border-2 flex items-center justify-center shrink-0 transition-all duration-150 ${isSelected ? 'bg-[#007acc] border-[#007acc]' : 'border-[#b4b4b4] bg-white'
                  }`}
              >
