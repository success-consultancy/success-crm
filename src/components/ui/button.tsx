...
const buttonVariants = cva(
  "inline-flex relative shrink-0 items-center justify-center whitespace-nowrap rounded-[.375rem] ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-primary-blue text-neutral-white hover:bg-component-hoveredBlue active:bg-component-active",
        success: "bg-utility-green text-neutral-white",
        destructive:
          "bg-utility-red text-white hover:bg-state-error-dark active:bg-button-800",
        destructiveHover:
          "hover:bg-state-error-light  hover:text-state-error-base",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-white-100 border border-stroke text-black-60  hover:border-black-60 active:border-black-60",
        tertiary:
